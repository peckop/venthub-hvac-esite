...
## 🎯 Hedefler
- [x] Kategori veritabanı şemasını profesyonel standartlara çekmek. ✅
- [x] UI üzerindeki zombi isim kirliliğini (HVAC Montaj...) temizlemek. ✅
- [x] Gateway yapısını yeni sütunlarla modernize etmek. ✅

## ✅ Alt Görevler
- [x] Adım 1: Veritabanı Şeması ve Veri Göçü (SQL) (Verify: menu_label eklendi) ✅
- [x] Adım 2: Yardımcı Fonksiyonların (Helpers) Evrimi ✅
- [x] Adım 3: Gateway ve Registry Senkronu ✅
- [x] Adım 4: UI Bileşenlerinin Modernizasyonu ✅
