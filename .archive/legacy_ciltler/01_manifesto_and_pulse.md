# 🧭 CİLT 1: VENTHUB PROJE ANAYASASI (MANIFESTO) & CANLI GÖREV DURUMU (PULSE)

Bu kitap, VentHub projesinin ruhunu, vizyonunu, kullanıcı profilini ve şantiyenin anlık iş durumunu tanımlayan tek ve değişmez referans noktasıdır.
...
*   **Yetenek:** Kod yazmayı ("syntax") bilmez ancak yazılım mimarisini, veri akışını ve algoritmik mantığı çok iyi bilir.
...
# 🛰️ VENTHUB MISSION CONTROL & PULSE STATUS
> [!IMPORTANT]
> VentHub e-ticaret geliştirme sürecinin canlı nabzını, aktif görevlerini ve şantiye statülerini anlık olarak takip etmek için registry altındaki master panomuzu inceleyebilirsiniz:
> - **Canlı Görev Panosu:** [registry/PULSE.md](file:///c:/Users/alize/venthub-hvac/registry/PULSE.md)

Buradaki görevler otonom motor (`manage_registry.py`) tarafından otomatik olarak yönetilmekte ve güncellenmektedir.