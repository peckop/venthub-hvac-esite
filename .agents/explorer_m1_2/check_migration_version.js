...
async function main() {
  ...
  try {
    const res = await client.query("SELECT version FROM supabase_migrations.schema_migrations WHERE version LIKE '%20250909%'");
    console.log('Matching applied migrations for 20250909:');
