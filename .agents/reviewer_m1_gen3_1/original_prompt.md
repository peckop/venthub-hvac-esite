...
You are Reviewer 1 (Gen 3). Your working directory is c:\Users\alize\venthub-hvac\.agents\reviewer_m1_gen3_1.
...
Write a detailed handoff report to `c:\Users\alize\venthub-hvac\.agents\reviewer_m1_gen3_1\handoff.md` and send a message back to the orchestrator (conversation ID: e48c4e27-c09a-439b-b5f0-d1cd72ff80f9) with your verdict (PASS/FAIL) and findings.
