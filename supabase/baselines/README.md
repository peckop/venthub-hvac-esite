...
| 2026-09-23 | `2026-09-23_public_schema.sql` | **TAM** (supabase db dump) | CI iş akışıyla (Yol A) alındı, koşum `35843632569`. 9877 satır / 368 KB. Canlı sayılar: **58 tablo · 58 PK · 20 unique · 111 FK · 209 indeks · 164 politika** (09-18'e göre +1 tablo / +2 indeks = #1338 `url_takma_adlari`, migrate 09:17:53Z). Dosyada 69 create table · 137 CREATE INDEX · 85 fonksiyon · 164 politika. Sebep: #1338 prod'a indi, INV-TABAN-TAZE-1 bütün açık PR'ları kırmızı yaktı. Sır taraması 12 imza **0**. ⚠Gölge geri yükleme bu turda KOŞULMADI. |
| 2026-09-24 | `2026-09-24_public_schema.sql` | **TAM** (supabase db dump) | CI iş akışıyla (Yol A) alındı, koşum `35985053064`. 9983 satır. Canlı sayılar: **59 tablo · 59 PK · 23 unique · 112 FK · 213 indeks · 165 politika** (09-23'e göre +1 tablo = REC-140 Faz 1 `product_costs`, migrate 09:49Z). Sebep: #1369 prod'a indi, INV-TABAN-TAZE-1 açık PR'ları kırmızı yaktı (taban aynı saatte yenilenmedi — ALTYAPI eksiği, ders migration-safety-standard). Sır imza taraması **0**. ⚠Gölge geri yükleme bu turda KOŞULMADI. |
| 2026-09-25 | `2026-09-25_public_schema.sql` | **TAM** (supabase db dump) | CI iş akışıyla (Yol A) alındı, koşum `36116761993`. 9988 satır. Canlı sayılar: **59 tablo · 59 PK · 23 unique · 112 FK · 213 indeks · 165 politika** (09-24 ile aynı — tablo eklenmedi). Sebep: REC-140 Faz 2-DB (#1374, karar 109) 2026-09-24 12:42Z'de prod'a indi; `inventory_summary`, `inventory_velocity`, `admin_search_products` gövdeleri `product_costs`'tan okur. 09-24 tabanına fark (satır sonu hariç) **139 satır, yalnız bu üç nesne**. ⚠Aynı saatte DEĞİL, ertesi gün alındı (oturum kesildi — ALTYAPI eksiği; kapı kırmızı vermedi çünkü tablo/kolon listesi değişmedi). Sır imza taraması **0**. Gölge geri yükleme KOŞULMADI. |
| 2026-09-25 (ikinci döküm, aynı dosya) | `2026-09-25_public_schema.sql` | **TAM** (supabase db dump) | Aynı gün İKİNCİ kez üretildi, dosya YERİNDE güncellendi (koşum `36122150184`, 10:06Z). 10357 satır. Canlı sayılar: **60 tablo · 60 PK · 23 unique · 112 FK · 214 indeks · 165 politika** (+1 tablo `quote_number_counters`). Sebep: SATIS #1373 (09:46:22Z), #1385 (09:46:57Z), #1410 (09:59:23Z) üçü prod'a indi; tip dosyası aynı PR'da (URUN 3380b0a00, cherry-pick). Sır imza taraması **0**. Gölge geri yükleme KOŞULMADI. |
