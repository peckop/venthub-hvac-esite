...
GRANT ALL ON FUNCTION "public"."arama_indeksi_tazele"("p_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."arama_indeksi_tazele"("p_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."arama_indeksi_tazele"("p_ids" "uuid"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."arama_kuyrugu_bosalt"("p_tavan" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."arama_kuyrugu_bosalt"("p_tavan" integer) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."tg_arama_aile_kuyrukla"() TO "anon";
GRANT ALL ON FUNCTION "public"."tg_arama_aile_kuyrukla"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."tg_arama_aile_kuyrukla"() TO "service_role";



GRANT ALL ON FUNCTION "public"."tg_arama_kategori_kuyrukla"() TO "anon";
GRANT ALL ON FUNCTION "public"."tg_arama_kategori_kuyrukla"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."tg_arama_kategori_kuyrukla"() TO "service_role";



GRANT ALL ON FUNCTION "public"."tg_arama_urun_tazele"() TO "anon";
GRANT ALL ON FUNCTION "public"."tg_arama_urun_tazele"() TO "authenticated";
