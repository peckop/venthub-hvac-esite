...
metadata:
  ...
  commands:
    validate: python -c "import pathlib; assert pathlib.Path('.claude/skills/venthub-auditor/scripts/run_audit.py').exists(), 'Audit script missing'; print('Venthub auditor skill ready.')"
depends_on:
