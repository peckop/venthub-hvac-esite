...
Gereksinim: Python 3 (`python --version`).
...
> Token kuralları SSOT = CLAUDE.md Kural 8: arbitrary Tailwind değeri yasak, renkler HEX değil HSL CSS custom property (`bg-background`, `text-primary` vb.).
