    ...
    <>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>İletişim: E-posta, telephone, teslimat/fatura adresi</li>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Meşru menfaat (m.5/2-f): Dolandırıcılık önleme, sistem güvenliği, operasyonlerin geliştirilmesi.</li>
