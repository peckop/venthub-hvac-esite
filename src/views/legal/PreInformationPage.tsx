...
import { PreInformationContentEn } from './components/en/PreInformationContent'
import { PreInformationContentTr } from './components/tr/PreInformationContent'

const PreInformationPage: React.FC<{ lang: string }> = ({ lang }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-light-gray p-6 text-steel-gray space-y-6 prose dark:prose-invert max-w-prose">
        {lang === 'en' ? (
          <PreInformationContentEn lang={lang} />
        ) : (
          <PreInformationContentTr lang={lang} />
        )}
      </div>
