        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-hvac-lg border border-white/20 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full bg-primary-navy text-white py-3 rounded-xl font-bold hover:bg-industrial-gray active:scale-98 transition-bg-transform-shadow shadow-hvac-sm flex items-center justify-center space-x-2 disabled:opacity-70"
            >
          ...
          <div className="mt-6">
            <button
              ...
              type="button"
              className="w-full bg-white border border-light-gray text-industrial-gray py-2.5 rounded-xl font-medium hover:bg-light-gray/30 active:scale-98 transition-bg-transform flex items-center justify-center space-x-3"
            >
              ...
              <span>{t('auth.loginForm.googleButton')}</span>
            </button>
          </div>
        ...
        <div className="mt-8 text-center">
          <Link href={Routes.home()} className="group inline-flex items-center gap-3 transition-colors duration-500">
            ...
            <div className="text-left">
              <div className="text-xl font-bold tracking-tight text-slate-900 group-hover:text-primary-navy transition-colors">{t('common.brand')}</div>
              <div className="text-xs font-medium uppercase tracking-hvac-normal text-slate-400">{t('common.brandTagline')}</div>
            </div>
          </Link>
          <p className="text-xs text-steel-gray font-medium">
            &copy; {new Date().getFullYear()} {t('common.brandLegalName')} <br />
            {t('footer.rights')}
          </p>
        </div>
      </div>
