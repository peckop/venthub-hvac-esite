      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className={`${adminCardClass} p-8 lg:p-10 space-y-6 relative overflow-hidden group flex flex-col justify-between`}>
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-3 text-sm text-slate-300">
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.siteName')}</span>
                <span className="font-semibold text-white">{generalValues?.site_name || '-'}</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.tagline')}</span>
                <span className="font-semibold text-white">{generalValues?.tagline || '-'}</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.contactEmail')}</span>
                <span className="font-semibold text-white">{generalValues?.contact_email || '-'}</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.supportPhone')}</span>
                <span className="font-semibold text-white">{generalValues?.support_phone || '-'}</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.headquarters')}</span>
                <span className="font-semibold text-white">{generalValues?.headquarters || '-'}</span>
              </p>
            </div>
          </div>
        ...
        <div className={`${adminCardClass} p-8 lg:p-10 space-y-6 relative overflow-hidden group flex flex-col justify-between`}>
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-3 text-sm text-slate-300">
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.iyzicoActive')}</span>
                <span className={`font-semibold ${paymentValues?.iyzico_enabled ? 'text-emerald-400' : 'text-slate-400'}`}>
                  {paymentValues?.iyzico_enabled ? t('admin.common.active') : t('admin.common.passive')}
                </span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.iyzicoMode')}</span>
                <span className="font-semibold text-white uppercase">{paymentValues?.iyzico_mode || '-'}</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.iyzicoApiKey')}</span>
        ...
        <div className={`${adminCardClass} p-8 lg:p-10 space-y-6 relative overflow-hidden group flex flex-col justify-between`}>
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-3 text-sm text-slate-300">
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.adminSessionTimeout')}</span>
                <span className="font-semibold text-white">{adminsValues?.admin_sessions_timeout} {t('admin.common.range')} (Saat)</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.mfaRequired')}</span>
                <span className={`font-semibold ${adminsValues?.mfa_required ? 'text-amber-400' : 'text-slate-400'}`}>
        ...
        <div className={`${adminCardClass} p-8 lg:p-10 space-y-6 relative overflow-hidden group flex flex-col justify-between`}>
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-3 text-sm text-slate-300">
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.systemLogLevel')}</span>
                <span className="font-semibold text-white uppercase">{systemValues?.system_log_level}</span>
              </p>
              <p>
                <span className="text-slate-500 font-bold block text-xs uppercase tracking-wider">{t('admin.settings.debugMode')}</span>
                <span className={`font-semibold ${systemValues?.debug_mode ? 'text-amber-400' : 'text-slate-400'}`}>
