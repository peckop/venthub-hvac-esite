...
/**
 * Retrieves all active categories from the database, ordered by hierarchy level and name.
 * Transforms raw database rows into domain-friendly `Category` objects.
 *
