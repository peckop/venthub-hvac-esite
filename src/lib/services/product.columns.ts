...
export const VARIANT_DETAIL_COLUMNS =
  'id, name, brand, price, sku, slug, model_code, category_id, subcategory_id, status, is_featured, description_i18n, family_id, stock_qty, low_stock_threshold, low_stock_override, technical_specs, created_at, updated_at, warehouse_location, supplier_name, purchase_price'
...
export const VARIANT_LIST_COLUMNS =
  'id, name, brand, price, sku, slug, model_code, category_id, subcategory_id, status, is_featured, family_id, stock_qty, created_at, updated_at'
