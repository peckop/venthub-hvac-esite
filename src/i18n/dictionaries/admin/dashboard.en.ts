export const dashboard = {
  ...
  newOrder: 'New Order',
  orderReceivedAmount: 'Order of ₺{{amount}} has been received.',
  unknownProduct: 'Unknown Product',
  stockMovement: 'Stock Movement',
  stockMovementDetail: '{{movementType}} for {{productName}}: {{qty}} Unit(s)',
  newOrderReceived: '🚀 New Order Received!',
  orderNotificationMessage: 'Order No: #{{orderNumber}} - Amount: {{amount}}',
  stockUpdated: '📦 Stock Updated',
  stockNotificationMessage: '{{movementType}} : {{qty}} Unit(s) ({{reason}})',
