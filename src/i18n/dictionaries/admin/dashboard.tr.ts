export const dashboard = {
  ...
  orderReceivedAmount: '₺{{amount}} tutarında sipariş alındı.',
  unknownProduct: 'Bilinmeyen Ürün',
  stockMovement: 'Stok Hareketi',
  stockMovementDetail: '{{productName}} için {{movementType}}: {{qty}} Adet',
  newOrderReceived: '🚀 Yeni Sipariş Alındı!',
  orderNotificationMessage: 'Sipariş No: #{{orderNumber}} - Tutar: {{amount}}',
  stockUpdated: '📦 Stok Güncellendi',
  stockNotificationMessage: '{{movementType}}: {{qty}} Adet ({{reason}})',
