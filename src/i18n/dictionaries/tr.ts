  ...
  category: {
    sections: {
      bottomCTA: {
        ...
        inspectModelsDesc: 'Tüm ürünleri görüntüle',
        findSuitable: 'Bana Uygun Olanı Bul',
        findSuitableDesc: '3 adımda doğru model',
      ...
      problemSection: {
        ...
        tempDiff: 'Sıcaklık Farkı',
        tempDiffDesc: 'Kapı açıldığında iç-dış ortam sıcaklık farkı',
        airFlow: 'Hava Akışı',
        airFlowDesc: 'Kontrolsüz rüzgar ve toz girişi',
        pestEntry: 'Zararlı Girişi',
        pestEntryDesc: 'Böcek ve toz partiküllerinin serbest geçişi',
        withoutCurtain: 'Hava Perdesi Olmadan',
        withoutCurtainPoints: ['Isı kaybı sürekli', 'Enerji faturası yüksek', 'Konfor düşük', 'Zararlı girişi kolay'],
        withCurtain: 'Hava Perdesi İle',
        withCurtainPoints: ['Görünmez enerji bariyeri', "%30'a varan tasarruf", 'Konforlu iç ortam', 'Zararlılara karşı kalkan']
      },
      trustSignals: {
      ...
      typeComparison: {
        ...
        electric: 'Elektrikli Isıtıcılı',
        electricSubtitle: 'Kış kullanımı için ideal',
        ambient: 'Ortam Havalı',
        ambientSubtitle: 'Enerji tasarrufu odaklı',
        advantages: 'AVANTAJLARI',
        bestFor: 'EN UYGUN:',
        notFor: 'TERCİH EDİLMEZ:',
        models: 'Modelleri',
        electricBenefits: ['Kapı önünde sıcak hava bariyeri', 'Kış aylarında enerji tasarrufu', 'Müşteri konforunu artırır', 'Termostat kontrollü ısıtma'],
        electricBestFor: ['Mağaza girişleri', 'Restoran kapıları', 'Otel lobileri', 'Soğuk iklimlerde'],
        electricNotFor: ['Soğuk hava depoları', 'Yaz mevsimi kullanımı'],
        ambientBenefits: ['Düşük enerji tüketimi', 'Soğuk zincir koruması', 'Hijyen bariyeri', 'Mevcut ısıtma sistemine ek'],
        ambientBestFor: ['Soğuk hava depoları', 'Market reyonları', 'Hastaneler', 'Yazlık mekanlar'],
        ambientNotFor: ['Isıtmasız mekanlar', 'Çok soğuk iklimlerde'],
        undecidedTitle: 'Hala kararsız mısınız?',
        undecidedDesc: '2 dakikalık ihtiyaç analizi sihirbazımız size en uygun tipi ve modeli önerecek.',
        helpMe: 'Bana Yardım Et',
        altText: 'Elektrikli vs Ortam Havalı Karşılaştırma'
      },
      vorticeBrand: {
        ...
        desc2: 'Attilio Pagani tarafından kurulan şirket, ilk ürünüyle İtalya\'nın en prestijli tasarım ödülü Compasso d\'Oro\'yu kazanmıştır. Bugün 90\'dan fazla ülkede milyonlarca kullanıcıya hizmet vermektedir.',
        authorizedDealer: 'Yetkili Bayi',
        ceCertified: 'CE Sertifikalı',
        warranty: '2 Yıl Garanti',
        premiumComfort: 'Premium Konfor',
        yearsExp: 'Yıl Deneyim',
        yearsExpDesc: '1954\'ten beri havalandırma',
        countries: 'Ülke',
        countriesDesc: 'Global dağıtım ağı',
        awardName: 'Compasso d\'Oro',
        awardDesc: 'İtalya\'nın en prestijli tasarım ödülü',
        europe: 'Avrupa',
        europeDesc: 'Havalandırma sektöründe lider',
        venthubPartnerPrefix: 'VentHub, ',
        venthubPartnerSuffix: ' ürünlerinin Türkiye yetkili satıcısıdır.',
        altText: 'Vortice Hava Perdesi Uygulaması'
      }
    },
