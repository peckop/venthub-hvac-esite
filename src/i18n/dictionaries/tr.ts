export const tr = {
  ...
  category: {
    ...
    findRightModel: '3 adımda doğru model',
    getExpertSupport: 'Proje danışmanlığı al',
    backToTop: 'Başa Dön',
    nextStep: 'Sıradaki Adımınız',
    nextStepDesc: 'Size en uygun {{category}} için yardımcı olalım',
    ...
    withoutAirCurtain: 'Hava Perdesi Olmadan',
    withAirCurtain: 'Hava Perdesi İle',
    trust: {
    ...
    vortice: {
      ...
      founded: '1954 yılında Milano\'da kurulan Vortice, 70 yılı aşkın süredir dünya genelinde havalandırma teknolojisinin öncüsü olmuştur.',
      history: 'Attilio Pagani tarafından kurulan şirket, ilk ürünüyle İtalya\'nın en prestijli tasarım ödülü Compasso d\'Oro\'yu kazanmıştır. Bugün 90\'dan fazla ülkede milyonlarca kullanıcıya hizmet vermektedir.',
      authorizedDealer: 'Yetkili Bayi',
      ceCertified: 'CE Sertifikalı',
      twoYearWarranty: '2 Yıl Garanti',
      premiumComfort: 'Premium Konfor',
      officialReseller: 'VentHub, Vortice ürünlerinin Türkiye yetkili satıcısıdır.'
    },
