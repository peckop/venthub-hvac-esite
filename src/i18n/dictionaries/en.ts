export const en = {
  ...
  knowledge: {
    hub: {
      ...
      subtitle:
        "Topic-based guides with (coming soon) calculators and a selection wizard to help you choose the right product.",
      searchPlaceholder: "Search topic…",
      readMore: "Read more",
      calculatorsSoon: "Calculators (Coming Soon)",
      calculatorsSoonDesc:
        "HRV airflow, jet fan coverage, air curtain velocity/flow and duct pressure drop.",
    ...
    topics: {
      "hava-perdesi": {
        title: "Air Curtain",
        summary:
          "Installed above entrances to preserve comfort and reduce energy loss; device should fully cover door width.",
        steps: [
        ...
        pitfalls: [
          "Device too short",
          "Too low velocity",
          "Tilting nozzle outward",
        ],
      },
      "jet-fan": {
        title: "Jet Fan (Parking)",
        summary:
          "Ceiling fans that direct flow to exhaust for CO/NOx and smoke scenarios; layout must avoid dead zones.",
        steps: [
      ...
      hrv: {
        ...
        summary:
          "Provides fresh air with heat recovery; key criteria are airflow, efficiency/SFP and external static pressure.",
        steps: [
  ...
  home: {
    guidedDiscovery: {
      ...
      subtitle:
        "Proceed through main categories to find the right premium series for your project.",
      viewSeries: "View Series",
      categories: {
        fans: {
          title: "Industrial Fans",
          desc: "Heavy-duty and high-efficiency fan solutions",
        },
        airCurtains: {
          title: "Air Curtains",
          desc: "Entrance solutions preventing heat and energy loss",
        },
        hrv: {
          title: "Heat Recovery",
          desc: "HRV units providing fresh air and energy efficiency",
        },
        control: {
          title: "Speed Control",
          desc: "Frequency inverters and automation panels",
        },
      },
    },
    applicationSolutions: {
      ...
      scenarios: {
        parking: {
          ...
          subtitle: "CO control and jet fan scenarios",
        },
        kitchen: {
          title: "Industrial Kitchen",
          subtitle: "Hood, filter, and exhaust solutions",
        },
        entrance: {
          title: "Store Entrances",
          subtitle: "Air curtain and climate control",
        },
        smoke: {
          title: "Smoke Extraction",
          subtitle: "Emergency and fire safety systems",
        },
        commercial: {
          title: "Commercial Spaces",
          subtitle: "Comfort-focused HRV systems for offices and malls",
        },
      },
    },
    featuredCommerce: {
    ...
    trustProof: {
      ...
      subtitle:
        "Secure your project with years of experience, authorized engineering support, and European standard product quality.",
      proofs: {
        brands: {
          title: "Premium Brands",
          desc: "Only certified global brands complying with European standards.",
        },
        engineering: {
          title: "Engineering Support",
          desc: "Free professional consulting in flow and pressure loss calculations.",
        },
        delivery: {
          title: "Nationwide Delivery",
          desc: "Insured, fast, and secure logistics network to all cities.",
        },
        support: {
          title: "After-Sales Guarantee",
          desc: "Authorized service network, 2-year warranty, and spare parts assurance.",
        },
      },
    ...
    strategicBrands: {
      ...
      subtitle:
        "We select world brands that have proven themselves in performance, energy efficiency, and durability for you.",
    },
    knowledgeBlock: {
      title: "Technical Guidance and Knowledge Hub",
      subtitle:
        "Engineering tools and documents to help you choose the right product.",
      cards: {
        guide: {
          title: "Product Selection Guide",
          desc: "Helps you find the most suitable device for your application step-by-step.",
        },
        calculators: {
          title: "Calculators",
          desc: "Quickly analyze your flow, static pressure, and power needs.",
        },
        support: {
          title: "Support Center",
          desc: "Access installation, maintenance, and commissioning documents.",
        },
      },
      explore: "Explore",
    },
    finalCta: {
      ...
      subtitle:
        "Our expert engineering staff is with you throughout all processes of your project.",
      contactExpert: "Talk to an Expert",
      requestQuote: "Request a Quote",
      exploreProducts: "Explore Products",
    },
    seoTitle:
      "VentHub - Premium HVAC Solutions | Fans, Speed Control, Heating & Cooling",
    seoDesc:
      "Discover premium ventilation products with VentHub. Engineering-supported solutions for parking jet fans, air curtains, heat recovery units, and more.",
    hero: {
      title:
        "Find industrial and commercial HVAC solutions with the right product, right category, and expert support.",
      subtitle:
        "Fans, air curtains, speed controllers, heat recovery, and project-oriented ventilation solutions. Product discovery, technical guidance, and fast quoting on a single platform.",
    ...
    heroSubtitle:
      "Turkey's most trusted HVAC distributor. 6 premium brands, 50+ product types for professional ventilation solutions.",
    bottomCtaTitle: "Let us help you choose the right product.",
    bottomCtaSubtitle:
      "Share your project details, our engineering team will guide you quickly.",
    whyParagraph:
      "With 15+ years of experience and world-class products, we are your trusted partner in the HVAC industry.",
    why: {
      premiumTitle: "Premium Quality",
      premiumText:
        "We select only the highest-quality products from globally recognized brands.",
      expertTitle: "Expert Support",
      expertText:
        "Our HVAC experts provide 24/7 technical support to find the best solution.",
  ...
  homeTrust: {
    ...
    subtitle:
      "Our infrastructure, security and processes are transparent and standards-compliant.",
    kvkk: {
  ...
  homeShowcase: {
    slide1: {
      ...
      subtitle:
        "Solutions tailored to your project and the right product selection",
    },
    slide2: {
  ...
  products: {
    ...
    helpCtaSubtitle:
      "Share your project details; our engineering team will respond quickly.",
    breadcrumbDiscover: "Discover",
    heroTitle: "Discover HVAC products: engineering-led selection, fast quotes",
    heroSubtitle:
      "Find the right product quickly with application-guided areas, popular categories and featured products.",
    ...
    discoverSeoDesc:
      "Discover products, featured items and popular categories on VentHub.",
    // Hub Section
    hubBadge: "Turkey's HVAC Expert",
    hubTitle: "Professional HVAC Solutions",
    hubSubtitle:
      "Air curtain, industrial fan and heat recovery systems. Let's find the right product for your needs together.",
  ...
  megamenu: {
    ...
    globalNavigatorDescription:
      "Manage every primary route outside category discovery from one premium panel.",
    curatedCategories: "Curated Categories",
    productsDescription:
      "Open product families, filtering entry points and the main product discovery flow.",
    brandsDescription:
      "Browse represented premium brands and brand-led discovery paths.",
    knowledgeHubDescription:
      "Access selection guides, technical content and the knowledge hub flow.",
    supportDescription:
      "Reach support center, assistance flows and operational guidance.",
    exploreSection: "Open Section",
    seriesShowcaseTitle: "Series showcase",
    mobileNavigatorTitle: "Mobile navigation",
    mobileNavigatorDescription:
      "Global routes and category discovery live in one premium mobile sheet.",
    mobileCategoryPrompt:
      "Choose a category, then open its series inside the mobile flow.",
    sectionOverview: "Overview",
    sectionCompany: "Company",
    sectionHint: "Switch sections to refresh the panel",
    companyPanelDescription:
      "Corporate pages, contact and support transitions are grouped here.",
    aboutDescription:
      "Review the VentHub approach, brand position and operating model.",
    contactDescription: "Reach sales, project and support teams quickly.",
    mobileCategoryLead:
      "Categories return to the first level on mobile. Dive into series through a compact list.",
    mobileExploreLead:
      "Products, brands and knowledge hub routes are presented as fast app-like rows.",
    mobileCompanyLead:
      "Corporate and support flows are gathered inside one mobile section.",
    needDifferentRoute: "Need somewhere other than categories?",
    needDifferentRouteHint:
      "Switch to Overview for products, brands and knowledge hub routes.",
  },
  categoryHub: {
    ...
    windowFallback:
      "Review products and technical variants inside this series.",
  },
  header: {
    brandName: "VentHub",
  ...
  admin: {
    ...
    products: {
      ...
      import: {
        ...
        dryRun: "Dry-run",
        dryRunResult:
          "Dry-run: required fields are {{status}}. Valid rows: {{ok}}/{{total}}",
    ...
    orders: {
      ...
      bulk: {
        ...
        confirmCancelShipping:
          "Are you sure to cancel shipping for {{count}} orders?",
      ...
      tooltips: {
        ...
        cancelBulkShipping:
          "Cancel shipping for selected (only shipped orders)",
      },
      modals: {
        shipping: {
      ...
      toasts: {
        ...
        shippingCancelConfirm:
          'Cancel shipping? This will set status to "Confirmed" and remove tracking.',
    ...
    webhooks: {
      ...
      search: {
        returns: "event_id, order_id, return_id, carrier, status_mapped",
    ...
    returns: {
      ...
      toasts: {
        ...
        emailNotifyFailed:
          "Email could not be sent, but the status was updated",
    ...
    users: {
      ...
      info: {
        ...
        items: {
          superadmin:
            "Superadmin: All privileges + role assignments (limited visibility for security)",
          admin:
            "Admin: Access to operations panel (inventory, returns, shipping, users)",
          moderator:
            "Moderator: Limited admin privilege (inventory and returns)",
  ...
  contactPage: {
    title: "Contact",
    subtitle:
      "Contact us for your project or product questions. We will get back to you as soon as possible.",
    ...
    quickDesc:
      "For urgent matters and quick responses, reach us directly via WhatsApp.",
  ...
  aboutPage: {
    title: "About VentHub",
    subtitle:
      "Your trusted partner for premium HVAC solutions. Corporate supply, engineering-assisted selection and fast quote processes.",
    stats: {
      premiumBrands: "Premium Brands",
      productTypes: "Product Types",
      yearsExperience: "Years Experience",
    ...
    bullets: {
      bullet1:
        "Engineering-focused selection support and proper product guidance",
  ...
  category: {
    ...
    localSearchPlaceholder:
      "Search within this category (name/brand/model/SKU)",
  ...
  cart: {
    ...
    emptyDesc:
      "You haven't added any products yet. Explore our products to start shopping.",
  ...
  auth: {
    ...
    resetSubtitle:
      "Enter your email to reset your password. We will send you a link.",
    ...
    passwordPwned:
      "This password has appeared in data breaches. Please choose a different, stronger password.",
    ...
    emailSentDesc:
      "A password reset link has been sent to {{email}}. Please check your email and click the link to set your new password.",
    backToLogin: "Back to Login",
    tryAnotherEmail: "Try Another Email",
    registrationCompleteTitle: "Registration Complete!",
    registrationCompleteDesc:
      "A verification link has been sent to your email. Please verify your account to complete registration.",
    errors: {
  ...
  checkout: {
    ...
    paymentLoading:
      "Payment form is loading. Please complete 3D verification. This page will refresh automatically when finished.",
    ...
    overlay: {
      ...
      stageBank: "Bank 3D",
      dontClose:
        "Do not close this page or go back during this process. It may take a few seconds.",
    },
    help: {
    ...
    consents: {
      ...
      readAcceptSuffix: "",
      orderConfirmText:
        "I confirm the order and accept the accuracy of product and delivery information.",
      marketingText:
        "I consent to receive commercial communications (optional).",
    },
    review: {
  ...
  payment: {
    ...
    verifyingDesc:
      "We are confirming the transaction with your bank. Please wait a moment.",
    failedTitle: "Payment Failed",
    retry: "Try Again",
    orderCompletedTitle: "Your Order is Complete!",
    orderNoLabel: "Order No",
    orderCompletedDesc:
      "Your order has been received successfully. A confirmation email will be sent shortly.",
    dateLabel: "Date",
  ...
  brands: {
    ...
    sectionSubtitle:
      "As Turkey's distributor of leading HVAC brands, we offer top-quality ventilation solutions.",
  ...
  categories: {
    ...
    subtitle:
      "Find professional ventilation solutions with our wide range covering all HVAC areas.",
  ...
  support: {
    ...
    returns: {
      ...
      desc1:
        "You may use your right of withdrawal within 14 days. The product must be unused and resalable with invoice and all accessories included.",
      desc2:
        "Please contact our support team with your order number for a return request. After approval, shipping instructions will be provided.",
    },
    shipping: {
      desc1:
        "Delivery usually takes 1–5 business days and may vary depending on campaigns and stock.",
      desc2:
        "Shipping fee/provider is shown at checkout. Tracking number will be sent via email.",
    },
    warranty: {
      desc1:
        "Warranty coverage may vary by manufacturer/importer. Please keep the warranty card and user manual.",
      desc2:
        "For service info or malfunction records, contact our support team.",
    },
    faq: {
