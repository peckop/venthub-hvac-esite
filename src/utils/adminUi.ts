...
export const adminTableHeadCellClass = 'text-left px-6 py-5 text-xs font-black text-slate-500 uppercase tracking-[0.2em] glass-strong border-b border-white/5'
...
export const adminButtonPrimaryClass = 'inline-flex justify-center items-center gap-2 px-6 h-12 rounded-2xl bg-cyan-400 text-surface-deep text-sm font-black uppercase tracking-widest hover:bg-cyan-300 hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400/50'
...
export const adminInputClass = 'w-full bg-white/[0.03] border border-white/10 rounded-xl pl-11 pr-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-cyan-400/20 focus:border-cyan-400/40 transition-colors placeholder:text-slate-600 font-bold'
export const adminSelectClass = 'w-full bg-white/[0.03] border border-white/10 rounded-xl pl-4 pr-10 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-cyan-400/20 focus:border-cyan-400/40 transition-colors font-bold cursor-pointer appearance-none bg-no-repeat bg-[right_0.75rem_center]'
...
export const adminSettingsLabelClass = 'block text-xs font-black text-slate-500 uppercase tracking-[0.2em] mb-3 ml-1'
