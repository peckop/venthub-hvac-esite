...
import { CategoryAuthoritySection } from '../../components/category/CategoryAuthoritySection'
  ...
  if (displayMode === 'showcase') {
    ...
    return (
      <>
        ...
        {/* Amiral Gemisi Otorite Katmanı (Tüm modlarda görünür olmalı) */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <CategoryAuthoritySection content={category.authority_content ?? null} />
        </div>
      </>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            {/* Amiral Gemisi Otorite Katmanı (50 Site Etkisi) */}
            <CategoryAuthoritySection content={category.authority_content ?? null} />
