 ...
 * Ölçüm 2026-08-30, boş makine: gövde **8,38 sn**, 14 alt süreç çağrısı (sınıfın en çok
 * süreç doğuran dosyası). Yük altında gözlenen amplifikasyon ~27× (tek gözlem: `eol` 1,47 → 39,9 sn).
