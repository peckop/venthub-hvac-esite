...
const BentoGrid: React.FC = () => {
  ...
  const items: BentoItem[] = [
    ...
    { title: t('homeGallery.items.airCurtain.title'), subtitle: t('homeGallery.items.airCurtain.subtitle'), image: '/images/bento/air-curtain.jpg', video: '/videos/air-curtain.mp4', topic: 'hava-perdesi', hrefProducts: '/category/commercial-ventilation/air-curtains' },
