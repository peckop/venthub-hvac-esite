...
const CategoryCard3D: React.FC<CategoryCard3DProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-slate-800/40 backdrop-blur-md border border-slate-700/50 rounded-2xl group-hover:shadow-[0_0_40px_-10px_rgba(56,189,248,0.25)] group-hover:border-sky-500/50 group-hover:bg-slate-800/60 transition-shadow duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] -z-10 pointer-events-none" />
