...
const NavSearchTrigger: React.FC<NavSearchTriggerProps> = ({
    ...
    return (
        ...
        >
            ...
            <kbd className="rounded-lg border border-slate-200 bg-slate-50 px-1.5 py-0.5 text-xs font-medium uppercase tracking-[0.2em] text-steel-gray shadow-sm hidden lg:block">
                {shortcutLabel}
            </kbd>
        </button>
    )
