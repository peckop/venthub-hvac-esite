...
const NavBrand: React.FC<NavBrandProps> = React.memo(({ brandName }) => {
    return (
        ...
        >
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-navy via-primary-navy to-secondary-blue text-white shadow-[0_18px_35px_-20px_rgba(37,99,235,0.7)] px-3 py-2 transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:shadow-[0_22px_40px_-18px_rgba(37,99,235,0.75)]">
            ...
            <div className="min-w-0 pr-3 sm:pr-4 border-r border-slate-200/80">
                <div className="whitespace-nowrap text-lg font-semibold tracking-[0.08em] text-slate-900 group-hover:text-primary-navy transition-colors">
                    {brandName}
                </div>
            </div>
        </Link>
