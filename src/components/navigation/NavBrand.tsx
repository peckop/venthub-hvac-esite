...
const NavBrand: React.FC<NavBrandProps> = ({ brandName }) => {
    return (
        <Link
            href="/"
            className="group flex shrink-0 items-center gap-3 w-[172px] pr-3 sm:pr-4 lg:pr-5 transition-all duration-300"
        >
            ...
            <div className="min-w-0 pr-3 sm:pr-4 border-r border-slate-200/80">
                <div className="truncate text-base font-semibold tracking-[0.08em] text-slate-900 group-hover:text-primary-navy transition-colors">
                    {brandName}
                </div>
            </div>
        </Link>
