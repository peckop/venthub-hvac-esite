      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-steel-gray max-w-3xl mx-auto">
            HVAC sektörünün her alanına yönelik geniş ürün yelpazesi ile 
            profesyonel havalandırma çözümlerinizi bulun.
          </p>
        </div>
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center text-secondary-blue group-hover:text-primary-navy transition-colors">
                    <span className="text-sm font-medium mr-1">
                      {getSubCategoryCount(category.id)} alt kategori
                    </span>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-steel-gray">
                    {getSubCategoryCount(category.id)} çeşit
                  </p>
                </div>
                <ArrowRight 
                  size={16} 
