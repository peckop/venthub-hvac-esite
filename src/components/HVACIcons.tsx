...
// Official SVG via Wikimedia to satisfy exact brand request
// If you prefer local asset, we can vendor the file into /public and load from there.
export const WhatsAppIcon: React.FC<IconProps & { variant?: 'solid' | 'glyph' }> = ({ className = '', size = 48 }) => {
  return (
    <img
