...
export const WhatsAppIcon: React.FC<IconProps> = ({ className = '', size = 48 }) => (
  ...
  >
    ...
    <path
      d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.472-.148-.67.15-.198.297-.767.967-.94 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.52.149-.173.198-.297.298-.495.099-.198.05-.372-.025-.521-.074-.149-.669-1.611-.916-2.206-.242-.58-.487-.502-.67-.512-.173-.009-.372-.011-.571-.011-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.095 3.2 5.076 4.487.709.306 1.262.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347Z"
      fill="#fff"
    />
    <path
      d="M12.051 22.689h-.003a8.76 8.76 0 01-4.688-1.37l-.335-.2-3.487.915.933-3.4-.215-.35a8.768 8.768 0 01-1.359-4.726c.003-4.844 3.946-8.785 8.77-8.782 2.341.001 4.532.912 6.186 2.568a8.72 8.72 0 012.58 6.2c-.003 4.845-3.946 8.785-8.77 8.782Z"
      fill="#fff"
    />
  </svg>
)
