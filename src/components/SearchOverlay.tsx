  ...
  const renderSuggestion = (s: SearchSuggestion, idx: number) => {
    ...
    return (
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-3 text-left transition-colors group outline-none ${isActive ? 'bg-air-blue/10 ring-inset ring-2 ring-primary-navy/20' : 'hover:bg-gray-50'}`}
      >
