    ...
    <section className="border-b border-slate-200/75 bg-white/95">
      <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8 lg:py-6">
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-xs font-semibold uppercase tracking-hvac-24 text-steel-gray">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {quickEntryItems.map((item) => (
            <Link
              key={item.id}
              href={item.href}
              className="group flex min-h-88px items-start gap-3 rounded-hvac-lg border border-slate-200 bg-white px-4 py-4 shadow-hvac-rail-1 transition-transform duration-300 hover:-translate-y-0.5 hover:border-primary-navy/20 hover:shadow-hvac-rail-2"
            >
              <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-primary-navy/10 bg-primary-navy/6 text-primary-navy transition-colors group-hover:border-primary-navy/20 group-hover:bg-primary-navy/10">
                {item.icon}
              </span>
          ...
          <button
            ...
            className="group flex min-h-88px items-start gap-3 rounded-hvac-lg border border-primary-navy/15 bg-entry-rail-gradient px-4 py-4 shadow-hvac-rail-1 transition-transform duration-300 hover:-translate-y-0.5 hover:border-primary-navy/25 hover:shadow-hvac-rail-2"
          >
