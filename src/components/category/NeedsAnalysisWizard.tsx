    ...
    return (
        <div className="bg-white border-2 border-primary-navy/10 rounded-xl p-6 shadow-xl animate-fadeIn">
            <div className="flex justify-between items-center mb-6">
                ...
                <button type="button" onClick={() => setIsOpen(false)} className="focus-ring text-gray-400 hover:text-gray-600">{t('needsWizard.close')}</button>
            </div>
            ...
            <div className="mt-6 flex justify-between items-center text-xs text-gray-400">
                ...
                {step > 1 && <button type="button" onClick={() => setStep(step - 1)} className="focus-ring hover:text-gray-600 underline">{t('needsWizard.goBack')}</button>}
            </div>
        </div>
    )
}
