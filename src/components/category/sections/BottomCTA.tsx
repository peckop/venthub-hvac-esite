            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-300 max-w-xl mx-auto">
                        {t("category.nextStepDesc", { category: categoryName.toLowerCase() })}
                    </p>
                </div>
                ...
                <div className={`grid gap-4 ${showWizard ? 'grid-cols-1 md:grid-cols-3' : 'grid-cols-1 md:grid-cols-2'}`}>
                    ...
                    {onShowProducts && (
                        ...
                        >
                            ...
                            <span className="text-sm text-gray-400">{t("category.viewAllProducts")}</span>
                        </button>
                    )}
                    ...
                    {showWizard && onOpenWizard && (
                        ...
                        >
                            ...
                            <span className="text-lg font-bold text-white mb-1">{t("category.findModel")}</span>
                            <span className="text-sm text-blue-100">{t("category.findRightModel")}</span>
                        </button>
                    )}
                    ...
                    >
                        ...
                        <span className="text-lg font-bold text-white mb-1">{t("common.expertSupport")}</span>
                        <span className="text-sm text-gray-400">{t("category.getExpertSupport")}</span>
                    </Link>
                </div>
                ...
                <div className="flex justify-center mt-8">
                    ...
                    >
                        ...
                        <span className="text-sm">{t("category.backToTop")}</span>
                    </button>
                </div>
            </div>
        </section>
