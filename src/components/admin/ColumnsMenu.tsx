    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content 
          className="min-w-[240px] glass-strong rounded-3xl border border-white/10 p-2 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in-95 duration-200 z-modal"
          align="end"
          sideOffset={8}
        >
          <div className="px-4 pt-3 pb-2 text-xs font-black uppercase tracking-[0.2em] text-slate-500 border-b border-white/5 mb-2 flex items-center gap-2">
            <Layout size={12} />
            ...
            {columns.map(col => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-4 h-4 rounded-md border transition-colors flex items-center justify-center ${col.checked ? 'bg-cyan-400 border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.3)]' : 'border-white/10 bg-white/5'}`}>
                    {col.checked && <Check size={10} className="text-surface-deep stroke-[4px]" />}
                  </div>
                  {col.label}
                </div>
              </DropdownMenu.CheckboxItem>
          ...
          <div className="px-4 pt-1 pb-2 text-xs font-black uppercase tracking-[0.2em] text-slate-500 flex items-center gap-2">
            <Maximize2 size={12} />
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-4 h-4 rounded-full border transition-colors flex items-center justify-center ${density === 'comfortable' ? 'bg-cyan-400 border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.3)]' : 'border-white/10 bg-white/5'}`}>
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-4 h-4 rounded-full border transition-colors flex items-center justify-center ${density === 'compact' ? 'bg-cyan-400 border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.3)]' : 'border-white/10 bg-white/5'}`}>
