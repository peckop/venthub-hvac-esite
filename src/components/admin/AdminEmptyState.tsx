            ...
            <div className="flex flex-col items-center justify-center py-8 px-4 text-center">
                ...
                {action && (
                    <button
                        ...
                        className="mt-5 px-5 py-2 rounded-xl text-xs font-black uppercase tracking-[0.2em] bg-white/5 border border-white/10 text-slate-300 hover:bg-white/10 hover:text-white transition-shadow shadow-xl"
                    >
                        {action.label}
                    </button>
                )}
    ...
    return (
        <div className="flex flex-col items-center justify-center py-20 px-6 text-center glass-strong rounded-hvac-2xl border border-dashed border-white/10 relative overflow-hidden group">
            ...
            {action && (
                <button
                    onClick={action.onClick}
                    className="relative z-10 px-8 py-3 rounded-2xl bg-cyan-400 text-surface-deep text-xs font-black uppercase tracking-[0.2em] hover:bg-cyan-300 transform hover:-translate-y-0.5 transition-transform shadow-xl shadow-cyan-400/20 active:scale-95"
                >
                    {action.label}
                </button>
            )}
