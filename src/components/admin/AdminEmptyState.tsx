    ...
    if (compact) {
        return (
            <div className="flex flex-col items-center justify-center py-6 px-4 text-center">
                <div className="w-12 h-12 bg-slate-50 flex items-center justify-center rounded-xl mb-3 text-slate-400">
                ...
                {action && (
                    <button
                        ...
                        className="mt-3 px-3 py-1.5 border border-slate-200 rounded-lg text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-primary-navy transition-colors bg-white shadow-sm"
                    >
                        {action.label}
                    </button>
                )}
