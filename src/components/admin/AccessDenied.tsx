...
const AccessDenied: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0A0F1E] flex flex-col items-center justify-center p-6">
            <div className="glass-strong rounded-[2.5rem] border border-white/5 p-12 max-w-lg w-full text-center shadow-[0_0_50px_rgba(0,0,0,0.4)] animate-in fade-in zoom-in-95 duration-500">
                ...
                <p className="text-slate-400 mb-10 leading-relaxed font-medium">
                    ...
                    <span className="text-[11px] font-bold text-slate-600 uppercase tracking-widest mt-4 block italic">Lütfen sistem yöneticinizle iletişime geçin.</span>
                </p>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="text-[10px] font-bold text-slate-700 uppercase tracking-[0.3em] mt-2">
