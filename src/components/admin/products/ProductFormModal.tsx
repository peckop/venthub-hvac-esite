        ...
        <Dialog.Root open={open} onOpenChange={onClose}>
            <Dialog.Portal>
                ...
                <Dialog.Content
                  ...
                  aria-modal="true" className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-90vh overflow-y-auto bg-white rounded-2xl shadow-2xl z-modal p-6">
