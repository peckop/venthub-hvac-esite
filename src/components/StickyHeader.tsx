...
export const StickyHeader: React.FC<StickyHeaderProps> = React.memo(function StickyHeader({ isScrolled }) {
  ...
  return (
    <>
      ...
      <NavShell mode="expanded">
        <NavBrand mode="expanded" brandName={t('header.brandName')} tagline={t('header.brandTagline')} />
          ...
          <NavActionButton
            ...
            badge={
              <>
                ...
                {cartCount > 0 && (
                  <span className="absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-primary-navy to-secondary-blue text-[11px] font-bold text-white shadow-md">
                    {cartCount}
                  </span>
                )}
              </>
      ...
      {isScrolled && (
        <NavShell mode="compact" fixed showProgress progress={scrollProgress}>
          <NavBrand mode="compact" brandName={t('header.brandName')} tagline={t('header.brandTagline')} />
          ...
          <NavUtilityRail mode="compact">
            ...
            <NavActionButton
              ...
              compactLabelClassName="hidden 2xl:block font-semibold text-success-green"
              badge={
                cartCount > 0 ? (
                  <span className="absolute -right-2 -top-2 flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-primary-navy to-secondary-blue text-[11px] font-bold text-white shadow-md">
                    {cartCount}
            ...
            {user ? (
              ...
              <Link
                href="/auth/login"
                className="rounded-xl bg-gradient-to-r from-primary-navy to-secondary-blue px-3 py-2 text-sm font-medium text-white shadow-[0_16px_28px_-18px_rgba(37,99,235,0.75)] transition-all duration-300 hover:-translate-y-0.5"
              >
                {t('common.signIn')}
              </Link>
            )}
