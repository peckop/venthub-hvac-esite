...
| `scripts/hijyen/sage-dosya-dersi.cjs` | SAGE DOSYA DERSİ modülü — çapa puanlaması (dosya 0.9 / dizin 0.5, ölçüldü), bütçe (2 ders · 300 karakter · 1024 bayt · 800 ms), "dosya başına bir kez" işaretleri ve compact nesli. | ALTYAPI | .claude/hooks/sage-dosya-dersi.cjs, .claude/hooks/session-board.cjs (betik taramasi) | olculemedi (repo disi izler taranmadi) | src/__tests__/conformance/sage-dosya-dersi.test.ts (6 kol) | KULLANIMDA |
