...
- **Biten (2026-08-10):** CSV denetim+normalizasyon (ingestor master ×2 commit) · cetvel v1.2 `#455` · i18n sızıntı fix `#456` · slug lokalizasyonu `#457` (migration prod'da, canlı 200/308 doğrulandı) · DURUM-TAKIP+CLAUDE.md yakalama (bu PR).
- **Açık:** Kademe-2 loader (plan bende, kod Opus dalgası; 4 yeni kategori + translation_key'ler TEK migration'da) · ₺0-fiyat ara-çözümü · fiyat motoru · görsel yükleme.
- **Kilit dosyalar:** `docs/plans/slug-localization-2026-08-10.md` · `docs/plans/catalog-commerce-pipeline-master-2026-06-20.md` · `docs/standards/category-taxonomy-standard.md` · ingestor CSV'leri.
