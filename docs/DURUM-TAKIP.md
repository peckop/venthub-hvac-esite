...
- **Açık:** **F5-B aile mimarisi** (plan HAZIR: `docs/plans/f5b-family-architecture-plan.md`, D0-D3 dalgaları yürütülecek; D4 legacy-kolon DROP = kullanıcı onayı ZORUNLU) · fiyat motoru (PS Wave 4; 348 EUR maliyet hazır) · görsel temini · leaked-password koruması (dashboard, manuel) · migrate-workflow sertleştirme · NLM twin sync (ana dizin skills şeridinde — boşalınca).
