<!-- uretilmis: Linear GraphQL disa aktarimi (scripts/nlm/linear_disa_aktar.py) · damga 2026-09-12T10:11:01Z · elle duzenlenmez; yenileme: gun kapanisi ritueli -->
# Linear İş Dağılımı — Şantiye Durumu (2026-09-12)

**Damga:** 2026-09-12T10:11:01Z · **Kaynak:** Linear GraphQL `issues` (sayfalama 3 çağrı) · **Toplam iş:** 206
...
Durum dağılımı: Done 3 · In Progress 43 · Todo/Backlog 158 · Canceled 1 → **genel % bitti 1%**

## §1 ÖZET — proje başına

| Proje | Toplam | Done | In Progress | Todo/Backlog | Canceled | % bitti |
|---|---:|---:|---:|---:|---:|---:|
| (projesiz) | 11 | 1 | 5 | 5 | 0 | 9% |
| Altyapı, Kapılar ve Belge Hattı | 86 | 2 | 20 | 63 | 1 | 2% |
| Katalog ve Ürün Verisi | 30 | 0 | 6 | 24 | 0 | 0% |
| Kurumsal Belgeler (DESIGN-BELGE) | 2 | 0 | 0 | 2 | 0 | 0% |
| Marka Kılavuzu (DESIGN-MARKA) | 3 | 0 | 0 | 3 | 0 | 0% |
| SEO ve Yayın | 7 | 0 | 5 | 2 | 0 | 0% |
| Teklif Akışı ve Müşteri Paneli | 23 | 0 | 2 | 21 | 0 | 0% |
| Vitrin 15A Yeniden Tasarım (DESIGN-MENU) | 44 | 0 | 5 | 38 | 0 | 0% |
| **TOPLAM** | 206 | 3 | 43 | 158 | 1 | 1% |

## §2 ŞERİT (etiket) başına

| Etiket | Toplam | Done | In Progress | Todo/Backlog | % bitti |
|---|---:|---:|---:|---:|---:|
| ALTYAPI | 65 | 0 | 11 | 53 | 0% |
| DESIGN | 6 | 0 | 0 | 6 | 0% |
| OPS | 30 | 0 | 3 | 27 | 0% |
| Recep kapısı | 17 | 0 | 6 | 10 | 0% |
| URUN | 81 | 1 | 17 | 63 | 1% |
| URUN-KATALOG | 16 | 0 | 7 | 9 | 0% |
| (etiketsiz) | 14 | 2 | 5 | 6 | 14% |
...
| REC-280 | In Review | ALTYAPI: MEMORY.md ortak hafıza indeksi — bayt tavanı uyarı kolu (eşik 15800) +  | ALTYAPI | 3 | 2026-09-08 |
| REC-283 | Backlog | URUN (ölçüm): pasif kategori vitrini KAPATMIYOR — is_active=false sayfa açık, di | URUN | 0 | 2026-09-08 |
| REC-285 | Backlog | URUN: altbilgideki DÖRT sosyal bağlantı bizim değil, platformların ana sayfasına | URUN | 0 | 2026-09-08 |
| REC-294 | Backlog | rate_limits tablosunda HAM IP süresiz saklanıyor — KVKK: IP kişisel veridir, tem | ALTYAPI | 3 | 2026-09-09 |
| REC-295 | Backlog | Teklif yazımı iki ayrı INSERT — transaction yok; kalem yazımı düşerse admin kuyr | URUN | 3 | 2026-09-09 |
...
| REC-168 | In Review | ALTYAPI: Satış kipine TEK ANAHTARLA geçiş — hide_price (37 kategori) + NEXT_PUBL | ALTYAPI, Recep kapısı | 3 | 2026-09-09 |
...
| REC-186 | In Review | URUN (K12): DD ailesi 6N090P → 61090P ad + slug düzeltmesi, eski slug 301, kanon | URUN | 3 | 2026-09-11 |
...
| REC-267 | In Review | ALTYAPI (REC-185 ardılı): araç envanteri elle değil, merge sonrası otomatik üret | ALTYAPI | 3 | 2026-09-08 |
...
| REC-287 | In Review | Mekanizma probu "bağımsız tanık" değil: jeton hedef dışı her gözcü bildirimine d | - | 3 | 2026-09-08 |
...
| REC-296 | In Review | ALTYAPI: Edge CORS allowlist'i *.vercel.app son-ekini kabul ediyor — yalnız kend | - | 4 | 2026-09-09 |
...
| REC-301 | In Review | OPS: gstack (Garry Tan, 23 skill) ile bizim skill/kanca setimizin ÖNYARGISIZ kar | - | 2 | 2026-09-12 |
...
| REC-121 | In Review | Tip-drift kapısı: migration inince database.types.ts canlı şemayla senkron mu —  | ALTYAPI | 0 | 2026-09-08 |
...
| REC-107 | Backlog | Hijyen: ortak depoda 36 worktree + 83 stash birikti — envanter ve bilinçli temiz | OPS | 4 | 2026-09-09 |
...
| REC-145 | Backlog | Belge deposu: ürün/aile teknik belgeleri (katalog PDF · veri sayfası · kılavuz · | URUN-KATALOG | 2 | 2026-09-11 |
...
| REC-206 | Backlog | KATALOG HATTI (çatı): kaynak belge → dizin → teknik/metin/görsel/belge → vitrin  | URUN-KATALOG | 2 | 2026-09-08 |
...
| REC-212 | In Review | TAŞINABİLİR KATALOG YOK: bugün USB/yeni makine ile 375 ürün baştan kurulamıyor — | URUN-KATALOG | 2 | 2026-09-11 |
...
| REC-282 | Backlog | KATALOG: altı SULU BATARYA ürünü YANLIŞ fotoğrafla satılıyor — ısı geri kazanım  | - | 2 | 2026-09-08 |
...
| REC-135 | Todo | Kategori ağacı boşlukları: 10 dalsız ürün + 7 boş alt dal (365/375 zaten dalında | URUN | 2 | 2026-09-09 |
...
| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-149 | Backlog | Projeler arası tasarım ayarı eşitleme — VentHub design system olarak üretilsin,  | DESIGN, OPS | 2 | 2026-09-09 |
...
| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-191 | In Review | URUN: Adres şeması + kategori ağacı + nitelik katmanı TEK YAYIN — geçiş planı (K | Recep kapısı, URUN | 2 | 2026-09-11 |
| REC-204 | In Review | URUN: İngilizce vitrin GEÇİCİ olarak dizinden çekilir — açılma şartı ölçülebilir | URUN | 2 | 2026-09-07 |
| REC-205 | In Review | URUN: GSC dizinleme kusurları — çift adres kanonikleştirme (34 adres) + giriş sa | URUN | 1 | 2026-09-08 |
| REC-268 | In Review | URUN: erişilebilirlik (a11y) — canlı anasayfa 96/100, 3 kırmızı denetim; accessi | URUN | 2 | 2026-09-08 |
| REC-297 | In Review | URUN: kategori sorgusu satırın tamamını çekiyor — emekli marketing_title kolonu  | - | 4 | 2026-09-09 |
| REC-300 | Backlog | URUN (K3-b): ADRES YAYINI — Türkçe önek (33×308) + model sayfası -p-<sku> (442 a | URUN | 2 | 2026-09-11 |

**Bing kökü ve hreflang**

| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-127 | Backlog | Bing kökü dizinleyemiyor: / → /tr 307 GEÇİCİ yönlendirme + hreflang x-default YO | URUN | 2 | 2026-09-09 |
...
| REC-88 | Todo | Açık kaynak CRM/ERP taraması + wacrm incelemesi — karar bekliyor | OPS, Recep kapısı | 0 | 2026-09-08 |
...
| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-117 | In Review | Misafir teklif akışı: teklif için üyelik zorunluluğu kalkıyor (Recep kararı) — a | Recep kapısı, URUN | 2 | 2026-09-09 |
...
| REC-281 | In Review | URUN: Ana sayfa kategori vitrini — mobilde yatay kaydırma karuseli UX gözden geç | URUN | 3 | 2026-09-08 |
| REC-288 | Duplicate | Kategori rotası HİÇ prerender edilmiyor: revalidate=3600 ve ISR vaadi ölü, her i | - | 3 | 2026-09-08 |
| REC-291 | In Review | URUN: "Alt Ürün Grupları" kartlarında GÖRSEL YOK — bölüm yalnız başlık + metin,  | URUN | 3 | 2026-09-08 |

**Faz 1 — Kabuk**

| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-89 | Backlog | Mobil vitrin kusurları: hero buton metinleri görünmüyor + PDP scroll'da görsel/m | URUN | 2 | 2026-09-08 |
...
| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-59 | In Review | SSG/ISR Dalga-2: 4 ana rota gerçekten statik olsun + SSR kapısı CI'a | URUN | 2 | 2026-09-09 |
...
| REC-128 | Backlog | Ana sayfa /tr ve /en DİNAMİK render: Cache-Control no-store + X-Vercel-Cache MIS | URUN | 0 | 2026-09-08 |
...
| İş | Durum | Başlık | Şerit | Öncelik | Son güncelleme |
|---|---|---|---|---:|---|
| REC-129 | Backlog | Kimlik + vitrin yeniden tasarımı — tek dil, fazlı üretim (logo/palet/ikon KAPALI | OPS | 2 | 2026-09-09 |
...
çağrı 3 · kayıt 206 · proje 8 · etiket 6 · bayat açık 0/48 · damga 2026-09-12T10:11:01Z
