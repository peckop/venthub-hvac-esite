...
| `soluk` | **#7A8290** · açık zeminde seçilmemiş/edilgen hâl |
| `soluk-koyu` | **#8FA2BD** · koyu zeminde seçilmemiş/edilgen hâl |

**Sönükleştirme dosyadan gelir.** `filter: grayscale()`, `opacity` veya çalışma anında renk
değişimi kullanılmaz (K22 · K23). Soluk sürümlerin geometrisi ana çizimin birebir aynısı; tek
renk, yarıçap ve gölge yok.

Ölçülen kontrast (soluk hâl bilgi taşımadığı için eşik aranmaz, sayı kayıt içindir):
`#7A8290` beyaz üstünde **3.87:1**, sayfa zemininde (`#F4F4F2`) **3.52:1** ·
`#8FA2BD` lacivert bantta **5.42:1**, `#0F1723` üstünde **6.92:1**.
