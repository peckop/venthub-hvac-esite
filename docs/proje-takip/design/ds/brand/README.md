...
<!-- türev kopya · kaynak DESIGN-MARKA brand/ · kopya 2026-09-06T07:00Z · elle düzenlenmez -->
...
İki istisna: logo dairesi `50%`, teklif paneli `8px` (`--radius-panel`).
`box-shadow` kullanılmaz.

## İkonlar

16 ikon: **7 kategori + 9 senaryo.** 26 dal için ikon çizilmez — 22 px'te ayırt
edilemiyor; dal ayrımını ürün fotoğrafı sağlar.
...
- Koyu zeminde lacivert dilimler beyaza döner
...
5. Vitrin **aydınlık gövde + koyu header/footer** olur; deponun koyu-mod-birincil kurgusu
   vitrinde terk edilir (admin ayrı karar).
