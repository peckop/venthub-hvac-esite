...
```
README.md: 62 satır (beklenen >= 200) — YETERSİZ
```
</details>
...
src\views\BrandDetailPage.tsx:159 -> <Image
...
src\views\category\CategorySeriesView.tsx:152 -> <div className="relative w-12 h-12 rounded-xl bg-white border border-
```
</details>
...
- src\views\account\AccountAddressesPage.tsx:174 | [JsxText <label>] | Text: "Adres Başlığı"
- src\views\account\AccountAddressesPage.tsx:175 | [JsxProp <placeholder>] | Text: "Ev, İş, Depo vb."
- src\views\account\AccountAddressesPage.tsx:180 | [JsxText <label>] | Text: "Ad Soyad / Firma"
- src\views\account\AccountAddressesPage.tsx:181 | [JsxProp <placeholder>] | Text: "Kişi veya Firma adı"
- 
```
</details>
...
| 12 | `L11_03_unused_dependencies` | Teknik Borç & Ölü Kod (Eski MRI Kapsamı) | package.json'da kullanılmayan dependency kalmamalı. |
