...
```
README.md: 55 satır (beklenen >= 200) — YETERSİZ
```
</details>
...
```
Bulgular (23):
src\components\admin\InventoryTable.tsx:79 -> <td className={adminTableCellClass + " " + cellPad}>
src\components\admin\InventoryTable.tsx:86 -> {visibleCols.physical && <td className={adminTableCellClass + " " + cellPad + " text-right font-mono font-bold text-slat
src\components\admin\InventoryTable.tsx:87 -> {visibleCols.reserved && <td className={adminTableCellClass + " " + cellPad + " text-right font-mono text-slate-500"}>{r
src\components\admin\InventoryTable.tsx:88 -> {visib
```
</details>
...
```
Bulgular (39):
src\views\AboutPage.tsx:73 -> <Image
src\views\AboutPage.tsx:124 -> <Image
src\views\AboutPage.tsx:149 -> <Image
src\views\BrandDetailPage.tsx:158 -> <Image
src\views\BrandsPage.tsx:138 -> <Image
src\views\ProductDetailPage.tsx:215 -> <ImageGallery images={images} productName={product.name} slug={product.slug || product.name} modelType={categoryMetadata
src\views\category\CategoryLandingView.tsx:117 -> <Image src={heroImage} alt={vm?.displayName || ''} fill className="object-cover
```
</details>
...
- src\views\account\AccountAddressesPage.tsx:173 | [JsxText <label>] | Text: "Adres Başlığı"
- src\views\account\AccountAddressesPage.tsx:174 | [JsxProp <placeholder>] | Text: "Ev, İş, Depo vb."
- src\views\account\AccountAddressesPage.tsx:179 | [JsxText <label>] | Text: "Ad Soyad / Firma"
- src\views\account\AccountAddressesPage.tsx:180 | [JsxProp <placeholder>] | Text: "Kişi veya Firma adı"
- 
```
</details>
...
src\components\category\CategoryShowcase.tsx:12 -> import { motion } from 'framer-motion'
src\components\home\CinematicProductShow
```
</details>
...
| `L11_02_bundle_analyzer` | WARNING | ⚠️ FAIL | Bundle bileşim analizi yapılmalı — hangi modül kaç KB, tree-shaking etkisi. |
...
<details>
<summary><b>L11_02_bundle_analyzer</b> — Kanıt</summary>
...
| 12 | `L11_02_bundle_analyzer` | Teknik Borç & Ölü Kod (Eski MRI Kapsamı) | Bundle bileşim analizi yapılmalı — hangi modül kaç KB, tree- |
| 13 | `L11_03_unused_dependencies` | Teknik Borç & Ölü Kod (Eski MRI Kapsamı) | package.json'da kullanılmayan dependency kalmamalı. |
